...
export default function ActualEfficiency() {
  ...
  const fetchEfficiencyData = async () => {
    ...
    try {
      ...
      let summaryUrl = `${API_BASE}/api/skyrina/period-summary?startDate=${startStr}&endDate=${endStr}`;
      ...
      let styleUrl = `${API_BASE}/api/skyrina/style-performance?startDate=${startStr}&endDate=${endStr}`;
      ...
      let lineDetailUrl = `${API_BASE}/api/skyrina/line-performance-detail?startDate=${startStr}&endDate=${endStr}`;
      ...
      const [stylesRes, linesRes] = await Promise.all([
        axios.get(`${API_BASE}/api/skyrina/available-styles?startDate=${startStr}&endDate=${endStr}`, { headers }),
        axios.get(`${API_BASE}/api/skyrina/available-lines?startDate=${startStr}&endDate=${endStr}`, { headers })
      ]);
